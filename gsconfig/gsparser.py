...
class BlockParser:
    def __init__(self, params):
        ...
        self.command_handlers = {
            ...
            'flist': lambda x: [x],
            # 'wrap': Оборачивает входное значение в список. Если входное значение само является списком,
...
class ConfigJSONConverter:
    ...
    * wrap - заворачивает в список если входное значение само является списком, и его первый элемент не является списком, то оно оборачивается в список еще раз
